...
void irRemote() { // Start irRemote function
  ...
  if (IrReceiver.decode()) {
    ...
    switch (IrReceiver.decodedIRData.command) { // Start switch/case
      
      case 12: // Relay 1 - Input 1
        {
